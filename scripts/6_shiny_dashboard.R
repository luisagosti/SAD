...
# 1. Carregar modelo treinado (ajuste do caminho)
...
api_key <- "2810b3593651a930239d07e75e3409f7"  # Substitua com sua chave real
...
get_weather_and_demand <- function(city_name) {
  ...
  # 3.2. Extrair e formatar dados da previsão
  ...
  # 3.3. Preparar dados para o modelo (com imputação default para variáveis ausentes)
  ...
  # 3.4. Prever demanda usando o modelo carregado
